...
import { Phone, Mail, Clock, Send, MessageSquare, CheckCircle } from "lucide-react";
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
                    ...
                    <div className="w-full lg:w-3/5">
                        <div className="mb-10">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mt-3 mb-5 tracking-tight">We'd Love to Hear from You</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select id="subject" className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all dark:text-white">
                    ...
                    <div className="w-full lg:w-2/5 flex flex-col gap-6 lg:pt-16">
                        ...
                        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-2xl p-7 text-white shadow-2xl shadow-blue-600/20 relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-blue-100 mb-6 text-sm leading-relaxed">Our support team is available during business hours to assist you.</p>
                                
                                <a href="tel:+97791521000" className="flex items-center justify-between bg-white text-blue-700 p-4 rounded-xl font-bold hover:bg-blue-50 transition-all group/call">
                                ...
                                <p className="text-center text-xs text-blue-200 mt-3 font-medium tracking-wide uppercase">Available Sun-Fri, 9AM-6PM</p>
                            </div>
                        </div>
                            ...
                            {CONTACT_INFO.map((item, i) => (
                                <div key={i} className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        {item.link ? (
                                            <a href={item.link} className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-sm">
                                                {item.linkText || item.content}
                                            </a>
                                        ) : (
                                            <>
                                                <p className="text-gray-600 dark:text-gray-400 text-sm">{item.content}</p>
                                                {item.subtext && <p className="text-gray-900 dark:text-white font-medium text-sm">{item.subtext}</p>}
                                            </>
                                        )}
                                    </div>
                                </div>
